...
% Variables
sim_dir = '../simulations/a/permeabilized/sim_data/pCa_length_control/sim_output';
n_cond = 3;

output_file_string = '../output/fig_force_pCa';
output_file_string_traces = '../output/fig_force_pCa_traces'
output_types = {'png', 'eps', 'svg'};

f_scaling_factor = 0.001;
y_traces_label_offset = -0.4;
y_label_offset = -0.22;
table_font_size = 8;
marker_size = 6;
